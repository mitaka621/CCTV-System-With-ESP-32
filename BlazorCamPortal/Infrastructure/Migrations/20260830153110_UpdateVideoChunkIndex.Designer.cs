...
namespace CamPortal.Infrastructure.Migrations
{
    ...
    [Migration("20260830153110_UpdateVideoChunkIndex")]
    partial class UpdateVideoChunkIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CamPortal.Infrastructure.Data.Entities.SmokeAlarmDetectorConfiguration", b =>
                {
                    ...
                    b.Property<double>("ChargeSenseVoltageThreashold")
                        .HasColumnType("float");

                    b.Property<double>("MaxVoltageOverchargeWarning")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("CamPortal.Infrastructure.Data.Entities.SmokeAlarmTelemetry", b =>
                {
                    ...
                    b.Property<double>("ChargingSenseVolts")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("CamPortal.Infrastructure.Data.Entities.VideoChunk", b =>
                {
                    ...
                    b.HasIndex("DeviceId", "ChunkStartTime");
